...
const I18N = {
  ru: {
    ...
    result: {
      ...
      toolbarHide: "Свернуть панель",
      toolbarShow: "Показать панель",
      playerHide: "Скрыть плеер",
      playerShow: "Показать плеер",
      playerSubtitle: "Исходный файл",
      playerPlay: "Воспроизвести",
      playerPause: "Пауза",
      playerMute: "Выключить звук",
      playerUnmute: "Включить звук",
      playerVolume: "Громкость",
      playerRate: "Скорость воспроизведения",
      playerRewind: "Назад 5 секунд",
      playerForward: "Вперед 5 секунд",
      playerPlayError: "Не удалось запустить плеер: {message}",
  ...
  en: {
    ...
    result: {
      ...
      playerShow: "Show player",
      playerSubtitle: "Source file",
      playerPlay: "Play",
      playerPause: "Pause",
      playerMute: "Mute",
      playerUnmute: "Unmute",
      playerVolume: "Volume",
      playerRate: "Playback speed",
      playerRewind: "Back 5 seconds",
      playerForward: "Forward 5 seconds",
      playerPlayError: "Unable to start player: {message}",
